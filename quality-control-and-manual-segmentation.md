...
we are interested in, with a reasonable signal to noise ratio.
...
Next, it's good practice to check the image histogram, which we'll do this in 
the exercise below:
...
[image display episode](../episodes/getting-started-with-napari.md#napari-plugins). It may also be useful 
...
](../episodes/what-is-an-image.md#bit-depth)). This matches the range on the x axis of our 
...
meaning they can often be compressed heavily without loss of information.
