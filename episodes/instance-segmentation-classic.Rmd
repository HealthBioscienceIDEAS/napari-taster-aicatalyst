...
something more applicable by segmenting some cells and measurig key 
...
First, we are going to use classic image processing techniques, like 
thresholding and filtering to segment the cells from the background of the image
:::::::::::::::::::::: instructor
...
with how much the images is blurred by adjusting sigma property.
