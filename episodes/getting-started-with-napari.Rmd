...
they appear inthe viewer. Moving the left node adjusts what is shown as fully 
black, while moving the right node adjusts what is shown as fully bright.

::::::::::::::::::::::::: instructor
Previously, there was a link to image-display - see if a relevant one can be 
made for this one. 
:::::::::::::::::::::::::

### Colormap
Again, we'll discuss this in detail in the [image display episode
](what-is-an-image.md#colormaps-luts), but briefly - the colormap determines what 
...
:::::::::::::::::::::::::: instructor
Don't go through this bit very much, just show napari-hub and
plugins page, but explain if you want to get more plugins how to do it.
::::::::::::::::::::::::::
...
::::::::::::::::::::::::::::::::::::: instructor
I've moved the plugins here as I think we just want to highlight this
and get people to download the key plugin. We will leave the challenges for
them do to on their own.
Also, you will need to do this on the conda environment and point out to them
that this instance doesn't allow additioal plugins through the GUI.
:::::::::::::::::::::::::::::::::::::
