...
μSAM provides a high‑level function for automatic segmentation: `micro_sam.segment.segment_image()`
...
# Load your image (example: napari sample)
import napari
viewer = napari.Viewer()
layer = viewer.open_sample("micro_sam", "micro_sam-livecell")
image = layer.data

# 1. Load predictor + automatic segmenter
predictor, segmenter = get_predictor_and_segmenter(
    model_type="vit_b"      # or vit_l / vit_h depending on availability
)
...
# 3. Visualise in napari
viewer.add_labels(auto_seg, name="auto_segmentation")
