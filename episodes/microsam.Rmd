...
Create a new notebook called `livecells.ipynb` to run the code below.
...
!["LIVECell Image"](fig/livecells.png)
...
!["Traditional Segmentation Method"](fig/livecells-traditional-segmentation.png)
